  ...
  $_SESSION['status-login'] != true;
    if(isset($_POST['masuk'])){
      ...
      $cek = mysqli_query($conn, "SELECT * FROM tb_admin 
        WHERE email = '".htmlspecialchars($_POST['user'])."' AND pass = '".htmlspecialchars($_POST['pass'])."' ");
      

      if(mysqli_num_rows($cek) > 0){
        $ab = mysqli_fetch_object($cek);
          $_SESSION['status-login'] = true;
          echo '<script>window.location="index.php?id='.$ab->id.'"</script>';
...
<body class="bg-gray-200">
  ...
  <main class="main-content  mt-0">
    <div class="page-header align-items-start min-vh-100" style="background-image: url('https://source.unsplash.com/WLUHO9A_xik/1600x900');">
